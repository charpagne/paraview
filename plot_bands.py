...
band_list = [1915,1995]
step = 0
plotWholeTRD = False  # make true if you want to plot the whole TRD containing the band for more realistic shape
...
def plot_all_bands(band_list):
    for band in band_list:
        ...
        origin_3D = [origin_2D[0],-12,origin_2D[1]]  # y=0 is the DIC surface
